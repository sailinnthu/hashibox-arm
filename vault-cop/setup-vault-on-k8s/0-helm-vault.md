...
hashicorp/terraform-cloud-operator      2.0.0           2.0.0           Official Helm chart for HashiCorp Terraform Clo...
hashicorp/terraform-enterprise          1.1.0           1.16.0          Official HashiCorp Terraform-Enterprise Chart     
...
helm pull hashicorp/vault --version 0.26.1 --untar
...
```
cat > helm-vault-raft-values.yaml <<EOF
server:
  affinity: ""
  ha:
    enabled: true
