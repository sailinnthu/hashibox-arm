...
# sudo curl -L "https://kind.sigs.k8s.io/dl/v0.19.0/kind-$(uname)-amd64" -o /usr/local/bin/kind
# sudo curl -L "https://kind.sigs.k8s.io/dl/v0.20.0/kind-$(uname)-amd64" -o /usr/local/bin/kind
sudo curl -L "https://kind.sigs.k8s.io/dl/v0.27.0/kind-linux-arm64" -o /usr/local/bin/kind
